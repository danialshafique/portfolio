  ...
  return (
    ...
    <main className=''>
      ...
      <div className="  md:font-medium justify-between md:justify-around xl:px-96 lg:px-72  sm:px-24  px-5   pt-10 flex  lg:text-[16px] lg:font-semibold  w-full overflow-hidden">
        ...
        <div className='w-full overflow-hidden max-w-screen-2xl mx-auto h-[100px] bg-gray-900 justify-center text-center  lg:text-[16px] lg:font-semibold  text-white-500 pt-5'>
